# 📊 Dashboard de Análise de Retalho (Power BI)

- Dashboard desenvolvido para analisar produtos próximos da data de validade no retalho. A solução inclui métricas DAX, análise de vendas, descontos, margem, padrões de não-venda e impacto da proximidade da validade no comportamento de compra.
...
- Descontos elevados aceleram vendas, mas nem sempre garantem rentabilidade.  
- Certos SKUs e marcas mantêm desempenho estável mesmo com descontos reduzidos.  
- A proximidade da data de expiração é um dos fatores mais determinantes no tempo de venda.  
- Produtos não vendidos concentram-se em dias específicos da semana,
